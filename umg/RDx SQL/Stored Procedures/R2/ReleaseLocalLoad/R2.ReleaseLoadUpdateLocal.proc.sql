...
-- =============================================
CREATE PROCEDURE R2.ReleaseLoadUpdateLocal
AS
BEGIN
	...
	from 
		...
		inner join R2.LoadReleaseLocal l 
			on t.[RELEASE_ID] = l.[RELEASE_ID] and t.[COMPANY_ID] = l.[COMPANY_ID] 
	...
	-- update row counts		
	exec R2.TransformLogTaskInsert 'R2.ReleaseLocal', @@rowcount, 'U'
