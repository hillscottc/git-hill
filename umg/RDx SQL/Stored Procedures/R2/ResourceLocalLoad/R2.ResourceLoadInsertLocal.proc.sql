-- ============================================
-- Description:	Inserts records in R2.ResourceLocal
-- =============================================
CREATE PROCEDURE R2.ResourceLoadInsertLocal 
AS
BEGIN
	insert into R2.ResourceLocal
	select 
	...
	-- update row counts		
	exec R2.TransformLogTaskInsert 'R2.ResourceLocal', @@rowcount, 'I'
